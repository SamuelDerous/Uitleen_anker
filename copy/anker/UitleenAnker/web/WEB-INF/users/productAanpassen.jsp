					...
					<table border="0" align="center" width="25%">
						<tr><td colspan="2"><div id="foutmelding" name="foutmelding">
                                                ...
                                                <tr><td><input type="hidden" name="productId" value="${product.id}" />
                                                        ...
                                                        Product:</td><td><b><span name="naam">${product.naam}</span></b> </td></tr>
                                                <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                                                ...
                                                <tr><td>Volledig</td><td><input type="checkbox" name="volledig" <c:if test="${product.volledig eq 1}">checked</c:if>></td></tr>
