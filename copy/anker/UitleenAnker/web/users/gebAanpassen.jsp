    ...
    <article id="formulier" align="center">
            ...
            <% 
                ...
                %>
                                                ...
                                                <tr><td>Gebruikersnaam:<span id="vereist">*</span></td><td><b><%= personen.get(0).getGebruikersnaam() %></b> </td></tr>
                                                <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
						...
						<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                                                <tr><td colspan="2" align="center"><input type="submit" value="Aanpassen" id="txtSubmit" /><input type="reset" value="Wissen" /><input type="button" name="btnWachtwoord" value="Reset ww" /></td></tr>
						<tr><td>&nbsp;</td><td>&nbsp;</td></tr>	
        </table>
</form>
    </article>
